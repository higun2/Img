...
from engine_jit_2 import train_one_epoch, evaluate
from denoiser_3 import Denoiser
...
def main(args):
    ...
    if global_rank == 0 and args.output_dir is not None:
        ...
        # wandb update
        run_name = args.output_dir.split('/')[-1]  # 경로의 마지막 부분 추출
        wandb.init(project='jit', config=args, name=run_name)
        log_writer = True

        wandb.tensorboard.patch(root_logdir=args.output_dir, pytorch=True)
